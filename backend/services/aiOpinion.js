...
- 두 번째 문장: 답이나 해법을 찾아가는 방법을 떠올리게 하는 짧은 질문 하나야. 무엇을 관찰하거나 비교하거나 조사하거나 실험해 보면 알 수 있을지, 어디서 누구에게 알아볼 수 있을지, 집이나 학교에서 직접 확인해 볼 수 있는 건 무엇일지를 묻는 식이어야 해. 질문 주제에서 벗어난 다른 궁금증을 묻지 마.
