...
const STOPWORDS = new Set([
  ...
  // ── '있다/없다/하다/되다/같다' 등 서술어(용언) 활용형 — 조사 제거로는 안 걸러지는 짧은 형태들
  '있어', '있을', '있나요', '있는', '있다', '있고', '있으면', '있는지', '있을까요',
  '없어', '없을', '없나요', '없는', '없다', '없고', '없으면', '없는지', '없을까요',
  '될까', '되나요', '되는', '된다', '되고', '되어', '돼요', '되는지',
  '할까', '하나', '해서', '한다', '하고', '하며', '하면', '하는지', '할까요',
  '같아', '같은', '같아요', '같은데', '같을까', '같이',
  '거야', '거에', '거에요', '것에', '것이', '것같아요', '것같아', '그거', '저거',

  // ── 궁금/문의 표현 — 질문 앱 특성상 거의 모든 문장에 등장해 키워드로서 변별력이 없음
  '궁금', '궁금해요', '궁금한', '궁금할까요', '궁금해서', '궁금해',
